      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        ...
        >
          <div className="glass-panel p-8 md:p-12 h-full flex flex-col justify-center">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-charcoal mb-6 uppercase">
            The Leadership <br/>
          ...
          <div className="w-16 h-1 bg-corporate-red mb-8" />
            ...
            <blockquote className="text-2xl md:text-3xl font-serif italic text-gray-700 mb-8 leading-snug border-l-4 border-corporate-red pl-6">
